...
const OurSpecs = () => {
    ...
    return (
        <div id="specs" className='px-4 sm:px-6 my-12 sm:my-20 max-w-6xl mx-auto'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7 gap-y-10 mt-16 sm:mt-26'>
                {
