...
import { HomeIcon, SquarePlusIcon, SquarePenIcon, LayoutListIcon, TicketPercentIcon, MegaphoneIcon, UsersIcon, MessageSquareIcon, Grid3X3Icon, TruckIcon, CircleDollarSignIcon, KeyRoundIcon, HeadphonesIcon, ShieldAlertIcon, LayoutTemplateIcon, RadarIcon, GlobeIcon, ZapIcon, StarIcon, RadioIcon } from "lucide-react"
...
const AdminSidebar = ({ isMobileBottomNav = false }) => {
    ...
    const sidebarLinks = [
        ...
        { name: 'Live Visitors', href: '/admin/live-visitors', icon: RadioIcon },
