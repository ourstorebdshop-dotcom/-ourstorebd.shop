...
export const defaultCategories = [
    { id: 'cat_1', name: 'Decoration', order: 0, visible: true, image: null },
    { id: 'cat_2', name: 'Speakers', order: 1, visible: true, image: null },
    { id: 'cat_3', name: 'Watch', order: 2, visible: true, image: null },
    { id: 'cat_4', name: 'Headphones', order: 3, visible: true, image: null },
    { id: 'cat_5', name: 'Camera', order: 4, visible: true, image: null },
    { id: 'cat_6', name: 'Pen', order: 5, visible: true, image: null },
    { id: 'cat_7', name: 'Theater', order: 6, visible: true, image: null },
    { id: 'cat_8', name: 'Earbuds', order: 7, visible: true, image: null },
    { id: 'cat_9', name: 'Mouse', order: 8, visible: true, image: null },
    { id: 'cat_10', name: 'Cleaner', order: 9, visible: true, image: null },
]
...
const categorySlice = createSlice({
    ...
    reducers: {
        ...
        updateCategory: (state, action) => {
            ...
            const { id, name, visible, image } = action.payload
